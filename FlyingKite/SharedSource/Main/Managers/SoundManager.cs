...
namespace FlyingKite.Managers
{
    public class SoundManager : Service
    {
        ...
        protected override void Initialize()
        {
            ...
            this.LoadSound(SOUNDS.Chop1, WaveContent.Assets.Audio.chop1_wav);
            this.LoadSound(SOUNDS.Chop2, WaveContent.Assets.Audio.chop2_wav);
            this.LoadSound(SOUNDS.Crash, WaveContent.Assets.Audio.crash_wav);
            this.LoadSound(SOUNDS.Coin, WaveContent.Assets.Audio.coin_wav);
        }
