...
namespace P2PTank.Tools
{
    public class MapLoader
    {
        ...
        public async Task Load(string filePath, string materialWall, string materialFloor, EntityManager entityManager)
        {
        ...
        private Entity CreateCube(int currentX, int currentY, int z, string materialPath)
        {
            var cube = new Entity { IsStatic = true }
                ...
                .AddComponent(new MaterialComponent { MaterialPath = materialPath, UseCopy = true });
        ...
        private Entity CreatePlane(string materialPath)
        {
            var cube = new Entity { IsStatic = true }
                .AddComponent(new Transform3D()
                {
                    LocalPosition = new Vector3((maxX / 2), -0.001f, (maxY / 2) - 0.5f),
